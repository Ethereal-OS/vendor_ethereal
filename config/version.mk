...
ETHEREAL_VERSION := $(ETHEREAL_CODENAME)-$(ETHEREAL_MINOR)-$(ETHEREAL_BUILD)-$(ETHEREAL_BUILD_DATE)-$(ETHEREAL_BUILD_TYPE)
ETHEREAL_MOD_VERSION :=$(ANDROID_VERSION)-$(ETHEREAL_CODENAME)-$(ETHEREAL_MINOR)
ETHEREAL_DISPLAY_VERSION := EtherealOS-$(ETHEREAL_CODENAME)-$(ETHEREAL_MINOR)-$(ETHEREAL_BUILD_TYPE)
